...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "cmp-tabnine", "cmp-path", "cmp-nvim-lsp" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
